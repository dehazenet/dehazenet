...
from pre import *
from computer_psnr_ssim import *
...
parser.add_argument("--threads", type=int, default=8, help="Number of threads for data loader to use, Default: 8")
...
def test(test_data_loader, epoch):
    pre_save(model)
    psnr_mean,ssim_mean = to_psnr_ssim()
